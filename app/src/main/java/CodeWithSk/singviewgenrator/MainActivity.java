package CodeWithSk.singviewgenrator;
...
public class MainActivity extends AppCompatActivity {
    ...
    private SignView mSignaturePad;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mSignaturePad = (SignView) findViewById(R.id.signature_pad);
        mSignaturePad.setOnSignedListener(new SignView.OnSignedListener() {
            @Override
